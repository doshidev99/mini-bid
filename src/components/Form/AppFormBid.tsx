...
import AppFormReveal from "./AppFormReveal";
...
const AppFormBid = () => {
  ...
  const onFinish = async (values: any) => {
    ...
    try {
      ...
      if (data) {
        setDataBid({
          proofBid: data.data.proofObject,
          hash: data.data.hashAfter,
        });
        onToggle();
      }
    } catch (e) {
    ...
    <div>
      <div className="m-auto slide-top">
        <div className="card-bid">
          <div className="pb-4 font-game">BID</div>
              ...
              >
                ...
                <Form.Item>
                  <Button
                    ...
                    htmlType="submit"
                  >
                    {loading ? "Encrypt data" : " Generator Data"}
                  </Button>
                </Form.Item>
